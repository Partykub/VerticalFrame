...
def main():
    ...
    parser = argparse.ArgumentParser(description="Auto-Reframe: Automated Vertical Video Cropping")
    ...
    # --- MAIN PIPELINE (Offline / Multi-Pass) ---
    ...
    output_video = args.output if args.output else "output_reframe.mp4"
